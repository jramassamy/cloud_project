...
@Component({
  selector: 'app-challenge-list-admin-template',
  templateUrl: './challenge-list-admin-template.component.html',
  styleUrls: ['./challenge-list-admin-template.component.css']
})
export class ChallengeListAdminTemplateComponent implements OnInit {
